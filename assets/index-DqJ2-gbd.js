...
api.interceptors.response.use((response) => response, (error) => {
	...
	if (status === 401 && !requestUrl.includes("/accounts/login/") && !requestUrl.includes("/accounts/register/")) {
...
var logo_default = "data:image/png;base64,";
//#endregion
...
var _sfc_main = {
	...
	setup() {
		...
		const logoError = /* @__PURE__ */ ref(false);
...
var _hoisted_1 = { class: "flex flex-col min-h-screen bg-gray-50" };
var _hoisted_2 = {
	key: 0,
	class: "sticky top-0 z-50 bg-white shadow-md"
};
var _hoisted_3 = { class: "max-w-7xl mx-auto px-4 py-4 flex items-center justify-between" };
var _hoisted_4 = {
	key: 0,
	class: "text-xl font-bold text-blue-600"
};
var _hoisted_5 = { class: "flex items-center gap-4" };
var _hoisted_6 = { class: "text-gray-700 font-semibold" };
var _hoisted_7 = { class: "flex-grow" };
var _hoisted_8 = {
	key: 1,
	class: "bg-gray-800 text-gray-300 text-sm py-6 mt-12"
};
var _hoisted_9 = { class: "max-w-7xl mx-auto px-4" };
var _hoisted_10 = { class: "text-center" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_router_link = resolveComponent("router-link");
	const _component_router_view = resolveComponent("router-view");
	return openBlock(), createElementBlock("div", _hoisted_1, [
		$setup.isAuthenticated ? (openBlock(), createElementBlock("header", _hoisted_2, [createBaseVNode("div", _hoisted_3, [createVNode(_component_router_link, {
			to: "/equipos",
			...
			default: withCtx(() => [createBaseVNode("img", {
				...
				onError: _cache[0] || (_cache[0] = ($event) => $setup.logoError = true)
			}, null, 32), $setup.logoError ? (openBlock(), createElementBlock("span", _hoisted_4, " PokéTeam ")) : createCommentVNode("", true)]),
			_: 1
		}), createBaseVNode("div", _hoisted_5, [createBaseVNode("span", _hoisted_6, toDisplayString($setup.userName), 1), createBaseVNode("button", {
			onClick: _cache[1] || (_cache[1] = (...args) => $setup.handleLogout && $setup.handleLogout(...args)),
			class: "btn-secondary text-sm"
		}, " Logout ")])])])) : createCommentVNode("", true),
		createBaseVNode("main", _hoisted_7, [createVNode(_component_router_view)]),
		$setup.isAuthenticated ? (openBlock(), createElementBlock("footer", _hoisted_8, [createBaseVNode("div", _hoisted_9, [_cache[3] || (_cache[3] = createBaseVNode("p", { class: "text-center mb-3" }, " Pokémon is © Nintendo/Game Freak. PokéTeam Master AI is a fan project for educational purposes. We are not affiliated with The Pokémon Company. ", -1)), createBaseVNode("div", _hoisted_10, [createVNode(_component_router_link, {
			to: "/info",
			class: "text-blue-400 hover:text-blue-300 transition-colors"
		}, {
			default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode(" More Information ", -1)])]),
			_: 1
		})])])])) : createCommentVNode("", true)
	]);
}
var App_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-144fe669"]]);
//#endregion
//#region \0vite/preload-helper.js
var scriptRel = "modulepreload";
var assetsURL = function(dep) {
	return "/PokeTeamMaker/" + dep;
};
var seen = {};
...
app.mount("#app");
//#endregion
export { withCtx as C, toDisplayString as E, watch as S, ref as T, createVNode as _, useRouter as a, renderList as b, withModifiers as c, createBaseVNode as d, createBlock as f, createTextVNode as g, createStaticVNode as h, useRoute as i, Fragment as l, createElementBlock as m, authAPI as n, vModelSelect as o, createCommentVNode as p, teamsAPI as r, vModelText as s, _plugin_vue_export_helper_default as t, computed as u, onMounted as v, withDirectives as w, resolveComponent as x, openBlock as y };
